...
tables = {"schema":"","table":"","trusted_path_1":"/oni/ibge/pintec_semestral/","destination":"/oni/indic_inov_nac/pintec_semestral/tabelas/","databricks":{"notebook":"/biz/oni/indic_inov_nac/pintec_semestral/tabelas/trs_biz_pintec_semestral_tabelas_cnae_po"},"prm_path":""}
...
for f in dbutils.fs.ls(adl_trusted_1):
  print(f.name)
  for a in dbutils.fs.ls(f'{adl_trusted_1}/{f.name}'):
    ...
    fechamento = "camada biz - nova serie historica pintec 2021 2022 2023"
    ...
    path = f'{adl_destination_path}/{part1}/{part2}'
    print(path)
