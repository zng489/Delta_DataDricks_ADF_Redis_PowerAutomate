...
tables = {"schema":"","table":"","raw_path":"/usr/oni/mte/caged_trabalhador/identificada/","trusted_path":"/oni/mte/caged_trabalhador/identificada/","prm_path":"/usr/oni/mte/caged_trabalhador_identificada/mte_caged_trabalhador_identificada_raw_trs.xlsx"}
...
sheet_name = 'CAGED_TRABALHADOR_TRS'
...
df = df.withColumn("NR_ANO", f.substring('DT_COMPETENCIA_DECLARADA', 1, 4))
...
df.write.partitionBy('NR_ANO').mode('overwrite', ).parquet(path=adl_trusted, mode='overwrite')
