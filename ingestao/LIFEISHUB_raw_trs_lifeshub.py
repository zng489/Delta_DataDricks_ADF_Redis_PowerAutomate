...
tables =  {"schema":"","table":"","raw_path":"/usr/oni/observatorio_nacional/dimensionamento_sesi/base_industrias/","trusted_path":"/oni/observatorio_nacional/dimensionamento_sesi/base_industrias/","prm_path":""}
...
base_unificada = df.withColumn('cd_cnpj', f.lpad(f.col('cd_cnpj').cast('string'), 14, '0')) \
                               .withColumn('cd_cnpj_matriz', f.lpad(f.col('cd_cnpj_matriz').cast('string'), 14, '0')) \
                               .withColumn('cd_cnpj_raiz', f.lpad(f.col('cd_cnpj_raiz').cast('string'), 8, '0')) \
                               .withColumn('cd_mun_filial', f.lpad(f.col('cd_mun_filial').cast('string'), 6, '0')) \
                               .withColumn('cd_mun', f.lpad(f.col('cd_mun').cast('string'), 6, '0')) \
                               .withColumn('cd_cnae', f.lpad(f.col('cd_cnae').cast('string'), 7, '0'))
