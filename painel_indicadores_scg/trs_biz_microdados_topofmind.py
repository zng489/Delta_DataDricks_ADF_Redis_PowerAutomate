...
microdados_topofmind_path = "{adl_path}{trs}/{file_folder}/".format(adl_path=var_adls_uri, trs=dls['folders']['trusted'], file_folder=table['params'])

# COMMAND ----------

print(microdados_topofmind_path)

# COMMAND ----------

df = spark.read.format("parquet").option("header","true").option("encoding", "ISO-8859-1").load(microdados_topofmind_path, mode="FAILFAST")
