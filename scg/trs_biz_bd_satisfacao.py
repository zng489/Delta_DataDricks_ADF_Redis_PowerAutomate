...
table = {"copy_sqldw":"false",
 "params":"oni/pesquisas/scg/bd_satisfacao",
 "path_destination":"oni/painel_indicadores_scg/bd_satisfacao",
 "destination":"/oni/painel_indicadores_scg/bd_satisfacao",
 "databricks":{"notebook":"/biz/oni/painel_indicadores_scg/trs_biz_bd_satisfacao"}}
...
bdd_imagem_path = "{adl_path}{trs}/{file_folder}/".format(adl_path=var_adls_uri, trs=dls['folders']['trusted'], file_folder=table['params'])

# COMMAND ----------

df = spark.read.format("parquet").option("header","true").option("encoding", "ISO-8859-1").load(bdd_imagem_path, mode="FAILFAST")
