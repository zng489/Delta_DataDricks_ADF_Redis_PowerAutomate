...
De forma objetiva: manteremos o mesmo script da base já gerada anteriormente, incluindo o campo de "Valor Remuneração Média" e substituindo o campo "Município" por "Mesorregião". Para este último, será necessário um DE-PARA com tabela que montei e anexei ao card.
