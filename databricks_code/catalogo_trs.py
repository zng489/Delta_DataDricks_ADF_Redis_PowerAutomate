...
def SOURCE_SCHEMA_TABLE_(J):
  ...
  #conjunto_tabela 
  conjunto_tabela
  SOURCE_SCHEMA_TABLE_ = spark.createDataFrame(conjunto_tabela)
  return SOURCE_SCHEMA_TABLE_
...
This_request_is_not_authorized
...
_CATALAGO_TRS_PROD.display()

# COMMAND ----------

SOURCE_SCHEMA_TABLE_ = SOURCE_SCHEMA_TABLE_(J)

# COMMAND ----------

_CATALAGO_TRS_PROD__ = _CATALAGO_TRS_PROD.join(SOURCE_SCHEMA_TABLE_, _CATALAGO_TRS_PROD._paths_ == SOURCE_SCHEMA_TABLE_.path__, "right").drop(_CATALAGO_TRS_PROD._paths_) #.show() 

# COMMAND ----------

_CATALAGO_TRS_PROD__ = _CATALAGO_TRS_PROD__.select('path','path__','size_bytes','source_name','schema_name','table_name')

# COMMAND ----------

_CATALAGO_TRS_PROD__.display()
