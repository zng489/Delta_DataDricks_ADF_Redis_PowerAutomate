...
["{'namespace':'/oni', 'r':'/brazil_startups_on_stfile_foldeartupblink/','file_subfolder':'','file_name':'Brazil_Startups_on_StartupBlink_2025_1.csv', 'sheet_name':'','raw_path':'/usr/oni/startupblink/startups/mapeamento/','prm_path': '','extension':'csv','column_delimiter':',','encoding':'utf-8','null_value':''}"]


oni/mte/novo_caged/identificada/2020/202001/CAGEDMOV202001ID/

file = {'prefixo_comex':'/oni/comex/import/', 
        sub_1  sadasda
        sub_2 asdasdasda
        sbu_3 aasdasda

        'sheet_name':'','raw_path':'/usr/oni/startupblink/startups/mapeamento/',
        'prm_path': '',
        'extension':'csv',
        'column_delimiter':',',
