...
path_gov, path_csv_gov, path_gov_field
...
for fileinfo in file_list:
  if ".csv" in fileinfo.name:
    ...
    file_path = "{adl_path}/{file_path}".format(adl_path=var_adls_uri,default_dir=default_dir,file_path=file_path)    
