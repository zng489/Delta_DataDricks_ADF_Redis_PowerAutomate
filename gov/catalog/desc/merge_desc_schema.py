...
path_lnd_gov = "{adl_path}{default_dir}".format(adl_path=var_adls_uri,default_dir=default_dir) + '/'.join(['','gov','usr_upload','schema'])
path_schema = "{adl_path}{default_dir}".format(adl_path=var_adls_uri,default_dir=default_dir) + '/'.join(['','gov','tables','schema'])

# COMMAND ----------

env, path_lnd_gov, path_schema
