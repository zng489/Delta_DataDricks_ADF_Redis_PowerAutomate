...
path_lnd_gov = "{adl_path}{default_dir}".format(adl_path=var_adls_uri,default_dir=default_dir) + '/'.join(['','gov','usr_upload','table'])
path_table = "{adl_path}{default_dir}".format(adl_path=var_adls_uri,default_dir=default_dir) + '/'.join(['','gov','tables','table'])

# COMMAND ----------

env, path_lnd_gov, path_table
