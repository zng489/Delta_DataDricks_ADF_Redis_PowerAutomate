...
file = {"namespace":"/oni", "file_folder":"/observatorio_nacional/comercio_comtrade/tab_auxiliar/tabela_continentes.csv", 
        "file_subfolder":"", "file_name":"", "sheet_name":"",
        "raw_path":"/usr/oni/observatorio_nacional/comercio_comtrade/tabela_continentes/",
        "prm_path": "", 
...
sample = dbutils.fs.head(
    "abfss://datalake@cnibigdatadlsgen2.dfs.core.windows.net/tmp/dev/uld/oni/observatorio_nacional/comercio_comtrade/tab_auxiliar/tabela_continentes.csv",
    50000
)
resultado = chardet.detect(sample.encode())
print(resultado)
...
def load_csv_to_dataframe(file_path:str, file_extension=file['extension'],
    delimiter=file["column_delimiter"],
