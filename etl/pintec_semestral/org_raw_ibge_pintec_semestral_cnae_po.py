...
file = {"namespace":"/oni", "file_folder":"/ibge/pintec_semestral/", "file_subfolder":"", "file_name":"", "sheet_name":"","raw_path":"/usr/oni/ibge/pintec_semestral/","prm_path": "", 
"extension":"csv","column_delimiter":",","encoding":"utf-8","null_value":""}
...
for path in cf.list_subdirectory(dbutils, uld_path):
    try:
        ...
        parte = path.split("/pintec_semestral/")[1].split("/")[0]
        if parte.isdigit():
...
lista_tabelas =  ['proc_neg_gr_obst_cnae',
 'grau_nov_prod_cnae',
 'prod_proc_disp_pd_cnae',
 'prod_proc_evolu_disp_s_pjt_inc_po',
 ...
 'prod_proc_evolu_disp_s_pjt_inc_cnae',
...
========================================
n_proc_neg_gr_obst_po n_proc_neg_gr_obst_po
n_proc_neg_gr_obst_po n_proc_neg_gr_obst_po
n_proc_neg_gr_obst_po n_proc_neg_gr_obst_po
n_proc_neg_gr_obst
po
...
========================================
prod_proc_disp_pd_po prod_proc_disp_pd_po
prod_proc_disp_pd_po prod_proc_disp_pd_po
prod_proc_disp_pd_po prod_proc_disp_pd_po
prod_proc_disp_pd
po
...
========================================
prod_proc_evolu_disp_cnae prod_proc_evolu_disp_cnae
prod_proc_evolu_disp_cnae prod_proc_evolu_disp_cnae
prod_proc_evolu_disp_cnae prod_proc_evolu_disp_cnae
prod_proc_evolu_disp_cnae prod_proc_evolu_disp_cnae
prod_proc_evolu_disp_cnae prod_proc_evolu_disp_cnae
prod_proc_evolu_disp_cnae prod_proc_evolu_disp_cnae
prod_proc_evolu_disp
cnae
...
========================================
proc_neg_po proc_neg_po
proc_neg_po proc_neg_po
proc_neg_po proc_neg_po
proc_neg
po
========================================
n_proc_neg_gr_obst_cnae n_proc_neg_gr_obst_cnae
n_proc_neg_gr_obst_cnae n_proc_neg_gr_obst_cnae
n_proc_neg_gr_obst_cnae n_proc_neg_gr_obst_cnae
n_proc_neg_gr_obst
cnae
========================================
ef_pand_po ef_pand_po
ef_pand
po
========================================
prod_proc_n_apoio_pub_po prod_proc_n_apoio_pub_po
prod_proc_n_apoio_pub_po prod_proc_n_apoio_pub_po
prod_proc_n_apoio_pub
po
========================================
prod_proc_apoio_pub_instr_cnae prod_proc_apoio_pub_instr_cnae
prod_proc_apoio_pub_instr_cnae prod_proc_apoio_pub_instr_cnae
prod_proc_apoio_pub_instr
cnae
========================================
rel_sust_po rel_sust_po
rel_sust_po rel_sust_po
rel_sust
po
========================================
proc_neg_gr_obst_po proc_neg_gr_obst_po
proc_neg_gr_obst_po proc_neg_gr_obst_po
proc_neg_gr_obst_po proc_neg_gr_obst_po
proc_neg_gr_obst
po
========================================
prod_proc_apoio_pub_instr_po prod_proc_apoio_pub_instr_po
prod_proc_apoio_pub_instr_po prod_proc_apoio_pub_instr_po
prod_proc_apoio_pub_instr
po
========================================
prod_proc_evolu_disp_po prod_proc_evolu_disp_po
prod_proc_evolu_disp_po prod_proc_evolu_disp_po
prod_proc_evolu_disp_po prod_proc_evolu_disp_po
prod_proc_evolu_disp_po prod_proc_evolu_disp_po
prod_proc_evolu_disp_po prod_proc_evolu_disp_po
...
po
========================================
prod_proc_rel_coop_cnae prod_proc_rel_coop_cnae
prod_proc_rel_coop_cnae prod_proc_rel_coop_cnae
prod_proc_rel_coop_cnae prod_proc_rel_coop_cnae
prod_proc_rel_coop
cnae
========================================
ef_pand_cnae ef_pand_cnae
ef_pand
po
========================================
prod_proc_apoio_pub_po prod_proc_apoio_pub_po
prod_proc_apoio_pub_po prod_proc_apoio_pub_po
prod_proc_apoio_pub
po
========================================
proc_neg_cnae proc_neg_cnae
proc_neg_cnae proc_neg_cnae
proc_neg_cnae proc_neg_cnae
proc_neg
cnae
========================================
prod_proc_rel_coop_po prod_proc_rel_coop_po
prod_proc_rel_coop_po prod_proc_rel_coop_po
prod_proc_rel_coop_po prod_proc_rel_coop_po
prod_proc_rel_coop
po
========================================
prod_proc_n_apoio_pub_cnae prod_proc_n_apoio_pub_cnae
prod_proc_n_apoio_pub_cnae prod_proc_n_apoio_pub_cnae
prod_proc_n_apoio_pub
cnae
========================================
grau_nov_prod_po grau_nov_prod_po
grau_nov_prod_po grau_nov_prod_po
grau_nov_prod_po grau_nov_prod_po
grau_nov_prod
po
...
# Para cada coluna, verifica se ela tem apenas valores nulos
non_null_cols = [c for c in df.columns if df.filter(col(c).isNotNull()).limit(1).count() > 0]

# Cria um novo DataFrame só com as colunas que têm algum valor não nulo
df_no_null_columns = df.select(*non_null_cols)

df_no_null_columns.display()

# COMMAND ----------

# VALIDACAO

#df = spark.read.parquet('abfss://datalake@cnibigdatadlsgen2.dfs.core.windows.net/tmp/dev/raw/usr/oni/ibge/pintec_semestral/cnae/rel_sust')
#df = df.filter(df['NR_ANO'].isNotNull())
#df.display()

# COMMAND ----------

spark.read.parquet('abfss://datalake@cnibigdatadlsgen2.dfs.core.windows.net/tmp/dev/raw/usr/oni/ibge/pintec_semestral/cnae/prod_proc_evolu_disp').display()
